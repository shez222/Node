...
export type CsrfTokenAndHashPairValidator = (token: string, hash: string, possibleSecrets: Array<string>) => boolean;
export type CsrfCookieSetter = (res: Response, name: string, value: string, options: DoubleCsrfCookieOptions) => void;
export type CsrfTokenCreator = (req: Request, res: Response, ovewrite?: boolean, validateOnReuse?: boolean) => string;
